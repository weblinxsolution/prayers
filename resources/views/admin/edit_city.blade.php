...
@section('admin')
    ...
    <div class="main-content">
        ...
        <div class="container">
            ...
            <div class="card p-5">
                <form action="{{ Route('admin.editCitiesData' , ['id' => $cities->id] ) }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-6">
                            <div class="mb-3">
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Enter country code"
                                    name="country_code" required value="{{ $cities->country_code }}">
                            </div>
                        </div>
                        <div class="col-3">
