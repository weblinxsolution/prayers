    ...
    <div class="main-content">
        <div class="row mb-5">
            ...
            <div class="col-6 text-right">
                <a href="{{ Route('admin.addfeature') }}" class="btn btn-primary">Add Feature</a>
            </div>
        </div>
                            ...
                            <tbody>
                                @foreach ($features as $feature)
                                    <tr role="row">
                                        ...
                                        <td class="sorting_1">{{ $feature->title }}</td>
                                        ...
                                        <td>
                                            <div style="display: flex; gap: 4px;">
                                                <a href="{{ Route('admin.featureDetails' ,['id' => $feature->id ]) }}" class="btn btn-outline-info btn-sm">View Details</a>
                                                <a href="{{ Route('admin.edit.feature', ['id' => $feature->id]) }}"
                                                    class="btn btn-outline-primary btn-sm">Edit</a>
                                                     @if ($feature->status == '1')
                                                        <a href="{{ Route('update.featureStatus', ['id' => $feature->id]) }}"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="{{ Route('admin.delete.feature', ['id' => $feature->id]) }}"
